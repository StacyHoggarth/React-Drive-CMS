      ...
      >
        <ul className=${css(styles.list)}>
          <li className=${css(styles.item)}>
            ...
            <${Link} to="/" title="Home" className=${css(styles.itemLink)}>
              Home
            <//>
          </li>
          <li className=${css(styles.item)}>
            ...
            <a
              href="http://sdpod.azurewebsites.net"
        ...
        <ul className=${css(styles.list)}>
          ${Object.values(categories).map(
            (category, index) => html`
              <li key=${category.id}>
                <i className=${"fas fa-angle-right " + css(styles.icon)} />
                <button
                      ...
                      (article) => html`
                        ...
                        >
                          <${Link}
                            ...
                            title=${article.title}
                            to=${article.uri}
                            className=${css(styles.subItemLink)}
                          >
                            ${article.title}
                          <//>
                        </li>
